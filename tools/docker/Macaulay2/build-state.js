...
emulator.add_listener("serial0-output-byte", function(byte)
{
    ...
    if(!booted && serial_text.includes("i1 :"))
    {
        ...
        emulator.serial0_send('run "dmesg -n 1; sync; echo 3 >/proc/sys/vm/drop_caches"\n');

    }

    if(booted && !saving && serial_text.includes("i1 :"))
    {
        console.error("\n\nMacaulay2 Ready. Saving state...");
        saving = true;
